# Unlikely Intersections — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/unlikely-intersections-canonical-lane-mathlib.git
cd unlikely-intersections-canonical-lane-mathlib
lake exe
lake build
```
